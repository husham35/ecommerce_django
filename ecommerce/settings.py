...
SECRET_KEY = 'django-insecure-1zo8&5m74g1y9+ik4o_j%c5kpq_$9pvb(f&x*wp(w50qa1!8yy'
...
# STATICFILES_DIRS (this tells Django where to look for global static files)
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'ecommerce', 'static'),
]

# Media files
# Path where media files will be uploaded
MEDIA_ROOT = os.path.join(BASE_DIR, 'media/')

# Path to access media files
MEDIA_URL = 'media/'


# cart items managament
